...
export default function SelectorBar() {
    const { player, setPlayer, team, setTeam } = useAppContext();
    ...
    const selectedPlayer = players.find(
        (item) => String(item.playerId) === player
    );
    ...
    const selectPlayer = (item: Player) => {
        setPlayer(String(item.playerId));
        setPlayerSearch("");
        setPlayerOpen(false);
    };
            ...
            <div>
                ...
                >
                    {conferences.map((conference) => {
                        ...
                        const divisions = [
                            ...new Set(
                                conferenceTeams.map((item) => item.division)
                            ),
                        ];
